...
+ (id)isEqualToPoint:(NSPoint)targetPoint {
    return [[self alloc] initWithPoint:targetPoint];
}
...
+ (id)isEqualToSize:(NSSize)targetSize mode:(SizeMatchMode)mode {
    return [[self alloc] initWithSize:targetSize mode:mode];
}
...
+ (id)isEqualToRect:(NSRect)targetRect {
    return [[self alloc] initWithRect:targetRect];
}
...
+ (id)isEqualToRange:(NSRange)targetRange {
    return [[self alloc] initWithRange:targetRange];
}
